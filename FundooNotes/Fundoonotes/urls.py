...
urlpatterns = [
    ...
    path('api/archive/<int:pk>', ArchiveNotesAPIView.as_view(), name="archive-notes"),
    ...
    path('api/trash/<int:pk>', TrashNotesAPIView.as_view(), name="trash-notes"),
    path('api/pin/<int:pk>', PinNotesAPIView.as_view(), name="pin-notes"),
